"""
Django settings for planner_project project.
...
SECRET_KEY = 'django-insecure-$i5ok!!39#=x!ake@m%^aa)be@6%_1^e@$s1iz38!kg25#sr*z'
...
WSGI_APPLICATION = 'planner_project.wsgi.application'
